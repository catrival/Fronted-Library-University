...
import { useGetStudentByIdQuery, useUpdateStudentMutation } from '../../features/api/studentSlice';
...
export default function StudentsFormEdit(){
        ...
        try {
            ...
            if(!response){
                Swal.fire({
                    position: "top-end",
                    icon: "error",
                    title: "El estudiante no pudo ser actualizado, por favor verifique los datos",
            ...
            Swal.fire({
                position: "top-end",
                icon: "error",
                title: "El estudiante no pudo ser actualizado, por favor verifique los datoszzzz",
                showConfirmButton: false,
                timer: 1500
              })
        }
    ...
    const { data: student, isLoading, isError, error } = useGetStudentByIdQuery(params.id);
