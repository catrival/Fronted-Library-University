...
import { useGetBookByIdQuery, useUpdateBookMutation } from '../../features/api/bookSlice';
import Swal from 'sweetalert2'
import BooksForm from './BooksForm';

export default function BooksFormEdit(){
        ...
        try {
            ...
            if(!response){
                Swal.fire({
                    position: "top-end",
                    icon: "error",
                    title: "El libro no pudo ser actualizado, por favor verifique los datos",
    ...
    const { data: book, isLoading, isError, error } = useGetBookByIdQuery(params.id);
    ...
    return (
        <BooksForm props={{handleSubmit:handleSubmit, book:book}} />
    );
}